...
******************* Polymorphism in C++ ********************
   ...
   __________________ Compile time polymorphism______________

   In compile-time polymorphism, it is already known which function will run.
   Compile-time polymorphism is also called early binding, which means that you are already bound to the function call
   ...
   There are two types of compile-time polymorphism:
        ...
        but their parameters need to be different. If function overloading is done in the program and 
        ...
        Operator loading is also an example of compile-time polymorphism because the compiler already knows 
        at the compile time which operator has to perform the task.


   __________________ Run time polymorphism______________

    In the run-time polymorphism, the compiler doesn’t know already what will happen at run time. 
    Run time polymorphism is also called late binding. The run time polymorphism is considered slow because 
